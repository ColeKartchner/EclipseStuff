...
public class TestLinear {
	...
	/*
	 * @Test public void testStressfulAdd() { Dictionary<String, Integer> d = new
	 * HashDictionary<String, Integer>(1023);
	 * 
	 * // some basic additions assertEquals(Integer.valueOf(16),d.put("Jay", 16));
	 * assertEquals(Integer.valueOf(19),d.put("Tom", 19));
	 * assertEquals(Integer.valueOf(1),d.put("Sydney", 1));
	 * assertEquals(Integer.valueOf(31),d.put("Nate", 31));
	 * assertEquals(Integer.valueOf(31),d.put("Emily", 31));
	 ...
	 * assertEquals(5,d.size());
	 * 
	 * // replace an existing entry with the same value // should have no effect
	 * assertEquals(Integer.valueOf(31),d.put("Emily", 31));
	 * assertEquals(5,d.size());
	 * 
	 * // some basic retrievals assertEquals(Integer.valueOf(16), d.get("Jay"));
	 ...
	 * 
	 * // now ensure everything is present assertTrue(d.contains("Jay"));
	 ...
	 * 
	 * // now a stress test d = new HashDictionary<String, Integer>();
	 * 
	 * for (int i = 0; i < 50; i++) { assertEquals(Integer.valueOf(i),
	 * d.put(Integer.toString(i), i) ); }
	 * 
	 * for (int i = 0; i < 50; i++) { assertTrue(d.contains(Integer.toString(i))); }
	 * 
